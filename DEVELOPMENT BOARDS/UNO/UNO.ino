/*
  ...
  on an **Arduino Uno** to verify the functionality of key components, including:
  ...
  Usage:
  - **Before Uploading:** Select the correct **port** and set the board type to **Arduino Uno**.
...
void setup() {
    ...
    Serial.println("\n✅ Arduino Uno Self-Test Complete!");
}
