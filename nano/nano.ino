//Attention......
//Before uploading the code, choose the appropriate port and select arduino nano as the board.

// Arduino Nano Self-Diagnostic Test
...
void setup() {
    ...
    int pwmPins[] = {3, 5, 6, 9, 10, 11}; // PWM-capable pins
    for (int i = 0; i < 6; i++) {
        int pin = pwmPins[i];
        pinMode(pin, OUTPUT);
